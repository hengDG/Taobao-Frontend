...
// // };
// const categoryIconMap: Record<string, string | JSX.Element> = {
//   fashion: <Shirt />,
//   "beauty & health": <ScanHeart />,
//   "hobbies & gifts": <Gift />,
//   "home & living": <HouseHeart />,
...
//                 // />
//                 <span className="inline-flex items-center gap-1 [&>svg]:h-3 [&>svg]:w-3">
//                   {icon}
//                 </span>
//               )}
        ...
        {categories.map((group) => {
          ...
          return (
            <button
              ...
              type="button"
              onMouseEnter={() => openMenu(group)}
              className={`flex cursor-pointer items-center gap-1.5 rounded-lg px-2 py-1.5 text-xs font-semibold transition ${
                active
                  ? "bg-[#194891]/10 text-[#194891]"
