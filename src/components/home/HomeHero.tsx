...
export function HomeHero() {
  return (
    <main className="relative overflow-hidden px-4 sm:px-8 lg:px-15 lg:pt-3 lg:pb-3">
      <div className="pointer-events-none absolute inset-0 " />

      <div className="pointer-events-none absolute top-6 right-6 hidden h-56 w-[44%] rounded-full bg-[radial-gradient(circle,rgba(96,133,245,0.28)_1.2px,transparent_1.3px)] bg-[length:8px_8px] opacity-55 lg:block" />

      <div className="pointer-events-none absolute bottom-6 left-6 hidden h-32 w-[44%] rounded-full bg-[radial-gradient(circle,rgba(96,133,245,0.28)_1.2px,transparent_1.3px)] bg-[length:8px_8px] opacity-55 lg:block" />
      ...
      <section className="relative mx-auto hidden h-[30vh] w-full max-w-[95%] flex-col gap-5 lg:flex lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-[70%] max-w-3xl">
          <h1 className="text-4xl leading-tight font-extrabold tracking-tight text-[#194891] sm:text-5xl">
        ...
        <div className="relative hidden min-w-[30%] shrink-0 lg:bottom-5 lg:block 2xl:bottom-15">
          <img
            src="/airplane-3d.png"
            alt="Airplane logistics"
            className="h-full w-full object-contain lg:max-h-90 lg:pb-10 2xl:max-h-130 2xl:pb-30"
          />
        </div>
      </section>
    </main>
